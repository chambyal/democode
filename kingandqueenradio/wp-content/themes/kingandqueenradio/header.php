...
<head>
	...
	<?php endif; ?>
	<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory'); ?>/bootstrap.css" />
	<?php wp_head(); ?>
</head>
	...
	<div class="site-inner">
		...
		<header id="masthead" class="site-header" role="banner">
				...
				<?php  if ( has_nav_menu( 'primary' ) || has_nav_menu( 'social' ) ) : ?>
					...
					<div  id="menugtop" class="site-header-menu">
					...
					<?php endif; ?>
						...
						<?php if ( has_nav_menu( 'primary' ) ) : ?>
							<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php _e( 'Primary Menu', 'twentysixteen' ); ?>">
									<div style="padding:0;" class="site-header-main">
								<?php
									wp_nav_menu( array(
